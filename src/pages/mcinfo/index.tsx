...
const McInfoPage = () => {
  return (
    <div>
      <div className="p-8 my-4 bg-tetra-600 text-white rounded-lg">
        <Heading>WHITELISTA JEST WLACZONA</Heading>
        <Paragraph>jak chcesz grac to dm (@uxw)</Paragraph>
        <Button href="https://discordapp.com/users/224978978362884096/">
          @uxw na discord
        </Button>
        user id 224978978362884096
      </div>
      <div className="p-8  border border-neutral-800 rounded-lg">
        ...
        <Paragraph>
          od siebie polecam launcher <b>prisma launcher</b>, zaleznie od tego
          czy masz premke pobierasz albo oryginalnego albo zcrackowanego (zeby
          odpalac nonpremium)
        </Paragraph>
        <hr className="my-4 border-neutral-800" />
        ...
        <Paragraph>
          prisma launcher umozliwia latwe instalowanie modow, wiec powinno byc
          to banalnie proste. ruwniez polecam od sb pobranie gotowej paczki
        ...
        <Paragraph className="py-8">
          ...
          dodajesz i tyle, powinno smigac, na dole odnosnik do poradnika
        </Paragraph>
